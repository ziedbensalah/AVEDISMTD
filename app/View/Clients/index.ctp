<div class="clients index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('employeur'); ?></th>
			<th><?php echo $this->Paginator->sort('mat'); ?></th>
			<th><?php echo $this->Paginator->sort('adressedomicile'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($client['Client']['profession']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['tel']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['fax']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['mail']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['site']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['societe']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['employeur']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['mat']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['adressedomicile']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['reglement_id']); ?>&nbsp;</td>
		<td class="actions">
